...
/*2.2 Crie uma variáveis que tenha apenas os usuários que trabalham 
...
const trabalhaNoGoogle = usuarios.find(usuario => usuario.empresa === 'Google');
console.log(trabalhaNoGoogle);

/* 2.4 Multiplique a idade de todos usuários por dois e depois realize um filtro 
